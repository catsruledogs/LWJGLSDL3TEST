...
// native method "nsetupEnvData" (with "n" prefix), but our prebuilt
// liblwjgl.dylib exports "setupEnvData" (without "n" prefix).
// This function bridges the name mismatch by forwarding to the real implementation.
